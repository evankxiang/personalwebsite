  ...
  return (
    <>
      ...
      <section className="scioly-section">
        ...
        <p>
          I've had the amazing opportunity to compete in Science Olympiad since 6th grade, qualifying for the National Tournament twice. SciOly has given me some of most amazing opportunities, and I am forever grateful for the people who've guided me and for the people I've met. Since 8th grade, I've volunteered my time to write various exams for tournaments, covering a variety of topics, including biology, earth science, and physics. The table below is a compilation of all exams that I have written. Any exam that is released (either publicly or privately) is linked through the tournament name. For an official sanctioned non-invitational tournament (i.e. Regionals or States), I do/will not release a copy of the exam. Feel free to contact me on Discord (@banarnarsaurus) for notice of errata or if you have any questions! 
        </p>
      </section>
